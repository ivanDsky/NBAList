...
/**
 * Precompiled core-conventions script plugin.
 **/
public class CoreConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_CoreConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("lint-conventions");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_CoreConventions").asSubclass(BasicScript.class);
